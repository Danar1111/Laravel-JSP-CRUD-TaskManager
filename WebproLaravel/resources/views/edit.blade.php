...
<body class="bg-light">
    ...
    <main class="container">
        ...
        @endif
        <form action='{{ url('home/'.$data->title) }}' method='post' autocomplete="off">
        @csrf
        @method('PUT')
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group due_date" id="datepicker">
                            <input type="text" class="form-control" id="due_date" name="due_date" value="{{ $data->due_date }}"/>
                        </div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" name='priority' id="priority" value="{{ $data->priority }}">
